...
import { useRouter } from 'expo-router'; // <-- ADICIONADO: Importar useRouter para navegação
...
  const { userId, isLoaded } = useAuth();
  const router = useRouter(); // <-- ADICIONADO: Hook para controlar a navegação
...
  },
  // ADICIONADO: Estilos para o novo cabeçalho
  header: {
    flexDirection: 'row',
    alignItems: 'center',
...
    flexGrow: 1,
  },
  // O estilo headerText foi removido pois não é mais necessário
  loadingContainer: {
    flex: 1,
